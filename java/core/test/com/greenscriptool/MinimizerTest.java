...
public class MinimizerTest extends BaseTest {
    ...
    protected String rootDir = "core/test/public";
    protected String jsDir = "core/test/public/javascripts";
    protected String cssDir = "core/test/public/stylesheets";
    protected String cacheDir = "core/test/public/gsCache";
    ...
    public void setUp() {
        ...
        jm.setRootDir(new File(rootDir));
        jm.setResourceDir(new File(jsDir));
        jm.setCacheDir(new File(cacheDir));
        jm.setResourceUrlPath(jsUrlPath);
        jm.setCacheUrlPath(cacheUrlPath);
        
        cm = new Minimizer(ResourceType.CSS);
        cm.setRootDir(new File(rootDir));
        cm.setResourceDir(new File(cssDir));
        cm.setCacheDir(new File(cacheDir));
