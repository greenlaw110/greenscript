...
h2. <a>What's New for v1.2.6a</a>

* Support LESS process for static service
** In other words, now you can get LESS compilation even you are using static css reference in your view like <link type="text/css" href="/public/stylesheets/myLessCss.css">. This feature could benefit those people who are using Japid or new Scala template system where
GreenScript tags are not available yet
...
bc. #{greenscript.css}
#{greenscript.@lessImport 'lib/color' /}
#body {
  color: @fgColor;
