...
public class app_rythm_main_html__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(780);
p("<!DOCTYPE html>\n<html>\n    <head>\n        <title>"); //line: 4

p(_getRenderProperty("docTitle", null));p("</title>\n        <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n        "); //line: 6
{ //line: 6
	...
	_pl.add("","ie"); //line: 6
	_pl.add("browser","lt IE 8"); //line: 6
	_pl.add("media","screen"); //line: 6
		_invokeTag("greenscript.css", _pl, false); //line: 6
} //line: 6
p("\n        "); //line: 7
{ //line: 7
	com.greenlaw110.rythm.runtime.ITag.ParameterList _pl = null;  //line: 7
	_pl = new com.greenlaw110.rythm.runtime.ITag.ParameterList(); //line: 7
	_pl.add("","layout color"); //line: 7
	_pl.add("output","all"); //line: 7
		_invokeTag("greenscript.css", _pl, false); //line: 7
} //line: 7
p("\n        "); //line: 8
{ //line: 8
	com.greenlaw110.rythm.runtime.ITag.ParameterList _pl = null;  //line: 8
	_pl = new com.greenlaw110.rythm.runtime.ITag.ParameterList(); //line: 8
	_pl.add("output","all"); //line: 8
		_invokeTag("greenscript.js", _pl, false); //line: 8
} //line: 8
p("\n    </head>\n    <body>\n        <div id=\"header\">\n            <h1>"); //line: 12

p(_getRenderProperty("docTitle", null));p("</h1>\n        </div>\n        \n        <div id=\"content\">\n            "); //line: 16
_pLayoutContent(); //line: 16
p("\n        </div>\n       \n        <div id=\"footer\">\n            greenlaw110"); //line: 20
p("@gmail.com\n            <br/><a href=\"/gsconf\" target=\"_blank\"> >> Config GreenScript</a>\n            <br/><a href=\""); //line: 22
p(s().raw(new com.greenlaw110.rythm.play.utils.ActionBridge(false,false).invokeMethod("singlePage", new Object[] {}))); //line: 22
p("\" target=\"_blank\"> >> Go to Single Page Template Demo</a>\n        </div>\n        \n    </body>\n</html>\n"); //line: 27
