...
public class app_rythm_greenscript_closeTag__html__R_T_C__ extends com.greenlaw110.rythm.template.TagBase {

	@Override public java.lang.String getName() {
		return "greenscript.closeTag_";
	}
   ...
   protected String _url(boolean isAbsolute, String action, Object... params) {
	...
	@Override public com.greenlaw110.rythm.utils.TextBuilder build(){
		out().ensureCapacity(130);
__ctx.pushEscape(com.greenlaw110.rythm.template.ITemplate.Escape.RAW); //line: 2
p("\n"); //line: 3

try{pe(("js".equalsIgnoreCase(type) ? "</script>" : ("css".equalsIgnoreCase(type) ? "</style>" : "" )));} catch (RuntimeException e) {handleTemplateExecutionException(e);}  //line: 3
p("\n"); //line: 4
